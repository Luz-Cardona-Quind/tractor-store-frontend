...
const IMG = (category: string) =>
  `http://localhost:4201/assets/images/products/${category}.svg`;

export const MOCK_PRODUCTS: Readonly<Record<string, Product>> = {
  // ─── Campo ────────────────────────────────────────────────────────────────────
  'p-c1': {
    id: 'p-c1', name: 'TractorMax 3000', category: 'campo', price: 85_000,
    images: [IMG('campo')],
    variants: [
  ...
  'p-c2': {
    id: 'p-c2', name: 'AgriPower X450', category: 'campo', price: 62_000,
    images: [IMG('campo')],
    variants: [
  ...
  'p-c3': {
    id: 'p-c3', name: 'FieldPro 600', category: 'campo', price: 120_000,
    images: [IMG('campo')],
    variants: [
  ...
  'p-c4': {
    id: 'p-c4', name: 'CampoMaster 800', category: 'campo', price: 145_000,
    images: [IMG('campo')],
    variants: [
  ...
  'p-c5': {
    id: 'p-c5', name: 'TerraForce 250', category: 'campo', price: 45_000,
    images: [IMG('campo')],
    variants: [
  ...
  'p-c6': {
    id: 'p-c6', name: 'AgriMax Turbo', category: 'campo', price: 98_000,
    images: [IMG('campo')],
    variants: [
  ...
  // ─── Industrial ───────────────────────────────────────────────────────────────
  'p-i1': {
    id: 'p-i1', name: 'InduMax 1200', category: 'industrial', price: 180_000,
  ...
  'p-i2': {
    id: 'p-i2', name: 'PowerBull X800', category: 'industrial', price: 135_000,
    images: [IMG('industrial')],
    variants: [
  ...
  'p-i3': {
    id: 'p-i3', name: 'HeavyDuty Pro', category: 'industrial', price: 220_000,
    images: [IMG('industrial')],
    variants: [
  ...
  'p-i4': {
    id: 'p-i4', name: 'IndusForce 2000', category: 'industrial', price: 250_000,
    images: [IMG('industrial')],
    variants: [
  ...
  'p-i5': {
    id: 'p-i5', name: 'WorkMaster 600', category: 'industrial', price: 95_000,
    images: [IMG('industrial')],
    variants: [
  ...
  // ─── Compacto ─────────────────────────────────────────────────────────────────
  'p-co1': {
    id: 'p-co1', name: 'MiniMax 120', category: 'compacto', price: 18_000,
    images: [IMG('compacto')],
    variants: [
  ...
  'p-co2': {
    id: 'p-co2', name: 'CompactPro 180', category: 'compacto', price: 24_000,
    images: [IMG('compacto')],
    variants: [
  ...
  'p-co3': {
    id: 'p-co3', name: 'QuadTrack 200', category: 'compacto', price: 32_000,
    images: [IMG('compacto')],
    variants: [
  ...
  'p-co4': {
    id: 'p-co4', name: 'MicroField 150', category: 'compacto', price: 21_000,
    images: [IMG('compacto')],
    variants: [
  ...
  'p-co5': {
    id: 'p-co5', name: 'SlimPower 90', category: 'compacto', price: 14_000,
    images: [IMG('compacto')],
    variants: [
  ...
  // ─── Huerto ───────────────────────────────────────────────────────────────────
  'p-h1': {
    id: 'p-h1', name: 'OrchardMaster 300', category: 'huerto', price: 42_000,
    images: [IMG('huerto')],
    variants: [
  ...
  'p-h2': {
    id: 'p-h2', name: 'FruitPro X200', category: 'huerto', price: 35_000,
    images: [IMG('huerto')],
    variants: [
  ...
  'p-h3': {
    id: 'p-h3', name: 'GardenForce 150', category: 'huerto', price: 28_000,
    images: [IMG('huerto')],
    variants: [
  ...
  'p-h4': {
    id: 'p-h4', name: 'HuertoMax 250', category: 'huerto', price: 38_000,
    images: [IMG('huerto')],
    variants: [
  ...
  'p-h5': {
    id: 'p-h5', name: 'PickFarm 180', category: 'huerto', price: 31_000,
    images: [IMG('huerto')],
    variants: [
